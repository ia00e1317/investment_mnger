...
<body>
	...
	<div id="thanks">
		<h1>投資案件管理メニュー</h1>
		<ol type="1">
			<li><a href="22_project_signup.php" target="_top">投資案件新規登録</a></li>
			<li><a href="23_project_list.php" target="_top">投資案件情報修正</a></li>
			<li><a href="25_project_category_edit.php" target="_top">カテゴリー情報編集</a></li>
		</ol>
